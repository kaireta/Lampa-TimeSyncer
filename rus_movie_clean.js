(function () {
    ...
    var today = new Date().isoIOSTring().substring(0, 10);
    ...
    var CATEGORIES = [
        ...
        { title: 'Start', img: 'https://bylampa.github.io/img/start.jpg', request: 'discover/tv?with_networks=3923&sort_by=first_air_date.desc&air_date.desc&air_date.lte=' + today },
    ...
    var css = '.rus-wrap { padding: 2em; height: 100%; box-sizing: border-box; overflow-y: auto; } ' +
              ...
              '.rus-card img { width: 100%; min-height: 100px; aspect-ratio: 16/9; object-fit: cover; display: block; } ' +
    ...
    function addMenuEntry() {
        ...
        var li = $('<li class="menu__item selector" data-action="rus_movie"><div class="menu__ico">' + icon + '</div><div class="menu__text">Сервисы (Clean Cache)</div></li>');
